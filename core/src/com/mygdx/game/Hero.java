...
public class Hero extends Entity{
    ...
    public Hero(Vector3 pos, Box2DWorld box2d){
        ...
        reset(box2d, pos);
        body = Box2DHelper.createBody(box2d.world, width/2, height/2,width/2, 0, pos, BodyType.DynamicBody);
    }

    public void reset(Box2DWorld box2d, Vector3 pos) {
        this.pos.set(pos);
        body = Box2DHelper.createBody(box2d.world, width, height, 0, 0, pos, BodyType.DynamicBody);
    }
    ...
    public void drawHealthBar(SpriteBatch batch) {
        ...
        // Draw the health bar
        batch.draw(healthBarTexture, pos.x, pos.y + height, healthBarWidth, healthBarHeight);
    }
}
